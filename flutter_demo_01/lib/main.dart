// 1
// 구글에서 제공하는(material) 기본 위젯과 테마들을 사용하기 위해서 가져와야한다.
...
// 위젯 트리를 생성해준다.
// 플러터는, 다트는 문장의 끝은 항상 세미콜론으로 마쳐야한다.
// main 함수 runApp 함수 MyApp 클래스
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // primarySwatch Swatch 견본 : 우리가 만들 앱에 사용하는 기본 음영들을 설정한다.
    return MaterialApp(
...
class MyHomePage extends StatelessWidget {
  ...
  // Scaffold : 발판을 만들어준다
  // 앱을 빨리 만들수 있도록 가장 많이 사용하는 시각적 레이아웃을 구성해주는 발판이다
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
