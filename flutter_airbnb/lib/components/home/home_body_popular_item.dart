...
class HomeBodyPopularItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // 인기 아이템은 전체 화면의 70%의 1/3만큼의 사이즈를 가질수 있도록하고
    // 사이즈 -5 만큼 크기를 가지게 설계한다.
  ...
  Widget _buildPopularItemComment() {
    return Column(
      children: [
        Text(
          "깔끔하고 다 갖춰져있어서 좋아요:, 위치도 완전 좋아용 다들 여기 살고 싶다고 ㅋㅋㅋㅋㅋ 화장실도 3개에요 !!! 5명이서 씻는것도 불편함 없이 좋았어요 ^^ 이불도 포근하고 좋습니다 ㅎㅎㅎㅎ",
          style: body1(),
          maxLines: 3,
